...
explain dropping of "regulatory compliance" and "legal compliances".
...
|            | QA2  | the article appeared in one of the legible journals        |
...
AQ2 - the studies retrieved from databases will be compared to a list of eligible journals (see: [Appendix B](#appendix-b)). 

The quality of an article is assessed on the basis of the 4 criteria(QA1 through QA4). The criteria are equally weighted. An article is assigned 1 point for every QA criterium that is met. An article will thus get score of 0 through 4.

Other metrics like author h-index and journal impact factor will not be considered in the selection process. 
...
Queries will be formulated for each data source.
...
The outcome for QA1 through QA4 is either 1 or 0.  
QA1=1: the article is of the type peer-reviewed journal article, QA=0: it is not.  QA2=1: the journal is in the eligible journals list, QA2=0: it is not.  
QA3=1 the article has been referenced an average of 5 times per year since publication, QA3=0: it has not.   
QA4=1 author 1 and author 2 have together authored at least 50 articles, QA4=0: they have not.  
...
For the final list we only consider the 8 articles where three or more conditions are met (see: [appendix E](#appendix-e), @tbl-full-text-included).
...
8-12 years ago: the two oldest papers in the dataset are @vanderfeestenProductbasedWorkflowSupport2011 and @hadaschInfluenceDirectiveExplanations2016.


4-8 years ago: the four papers published in the 2016-2019 timeslot are @vanderaalstSpreadsheetsBusinessProcess2018, @DBLP:journals/ail/HashmiG18, @hashmiAreWeDone2018, @viriyasitavatBlockchainasaServiceBusinessProcess2023 and @vanderaaComparingTextualDescriptions2017.


0-4 years ago: the three most recent papers in the set are the papers @bernardojuniorAgileBusinessProcess2023 and @kirKnowledgeintensiveAdaptiveBusiness2021.


Refer back to research question
...
Finally, the research question and the ..
