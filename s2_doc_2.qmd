...
<p style="padding: 10px; border: 2px solid red;">compliance by design</p>
...
Compliance by design refers to approaches and methodologies where compliance requirements are integrated into business process models and enterprise applications from the very beginning [@sadiqManagingRegulatoryCompliance2010]. This concept emphasizes embedding compliance within the fabric of business practices rather than treating it as a separate or after-the-fact activity [@lohmannComplianceDesignArtifactcentric2013].
