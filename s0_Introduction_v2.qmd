...
First, we'll perform a systematic literature review (SLR) with the intended outcome to define the research gap on the subject of this paper. We will find current research on "design for compliance" but the Benelux geographic context en the focus on (one aspect of) CSRD may still be a novel angle.
...
|   | mar.|  12 |18-03-2024 |       |                             |        |
|   | mar.|  13 |25-03-2024 |       |DBA Research Day (date??)    |        |
|   | apr.|  14 |01-04-2024 |       |                             |        |
