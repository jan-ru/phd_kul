...
# Journals, authors, keywords {#appendix-h}
...
print(tabulate(table, header, maxcolwidths=[40, 35, 10]))
...
print(tabulate(authors, headers=["First Author", "Other Authors"], maxcolwidths=[40, 50]))
```
...
print(tabulate(data, headers=['Citation Key', 'Keywords'], maxcolwidths=[20, 55]))
```
